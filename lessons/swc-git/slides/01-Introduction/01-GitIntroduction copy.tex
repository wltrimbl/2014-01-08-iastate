...
\frametitle{Why do I need version control?}
\begin{center}
\scalebox{0.4}{\includegraphics{../imgs/version_control.png}}
\end{center}
...
\begin{center}
\scalebox{0.4}{\includegraphics{../imgs/distributed-vc.png}}
\end{center}\pause
...
\begin{center}
\scalebox{0.4}{\includegraphics{../imgs/three_trees_of_git.png}}
\end{center}
\end{frame}
...
\begin{center}
\scalebox{0.4}{\includegraphics{../imgs/work.png}}
\end{center}
\end{frame}
...
\frametitle{How to save snapshots with \texttt{Git}}
\begin{center}
\scalebox{0.4}{\includegraphics{../imgs/work_add.png}}
\end{center}
\end{frame}
...
\frametitle{How to save snapshots with \texttt{Git}}
\begin{center}
\scalebox{0.4}{\includegraphics{../imgs/work_add_commit.png}}
\end{center}
\end{frame}
...
\begin{center}
\scalebox{0.3}{\includegraphics{../imgs/work_add_commit.png}}
\end{center}
\end{frame}
...
\begin{center}
\scalebox{0.4}{\includegraphics{../imgs/work_add_commit_work.png}}
\end{center}
\end{frame}
...
\frametitle{How to save snapshots with \texttt{Git}: Keep working!}
\begin{center}
\scalebox{0.4}{\includegraphics{../imgs/work_add_commit_work_add.png}}
\end{center}
\end{frame}
...
\frametitle{How to save snapshots with \texttt{Git}: Keep working!}
\begin{center}
\scalebox{0.4}{\includegraphics{../imgs/work_add_commit_work_add_commit.png}}
\end{center}
\end{frame}
...
\begin{center}
\scalebox{0.4}{\includegraphics{../imgs/diff_commits.png}}
\end{center}
\end{frame}
